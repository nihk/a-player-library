...
class LibraryView : FrameLayout {
    ...
    private var keyPlayerNonConfig: UUID? = null
    ...
    fun play(playerArguments: PlayerArguments) {
        play(playerArguments, UUID.randomUUID())
    }

    fun play(playerArguments: PlayerArguments, keyPlayerNonConfig: UUID) {
        stop()
    ...
    override fun onSaveInstanceState(): Parcelable {
        return bundleOf(
            ...
            KEY_PLAYER_NON_CONFIG to keyPlayerNonConfig?.let { ParcelUuid(keyPlayerNonConfig) }
        )
    }
    ...
    override fun onRestoreInstanceState(state: Parcelable?) {
        ...
        if (viewState is Bundle) {
            ...
            keyPlayerNonConfig = viewState.getParcelable<ParcelUuid>(KEY_PLAYER_NON_CONFIG)?.uuid
